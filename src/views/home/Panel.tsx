...
function Panel() {
  return (
    <section className="mt-[60px] w-full max-w-[1600px]">
      ...
      <div className="mx-[100px] mt-[70px] flex ">
        <div className=" mt-[65px] flex w-7/12 flex-col gap-[80px] px-6 text-white">
          <Info label="Easy">
        ...
        <div className=" relative  w-5/12">
          ...
          <div className="absolute h-[640px] w-[960px]">
